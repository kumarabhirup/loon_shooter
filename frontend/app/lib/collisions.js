...
function rectRectColliding(rectangle1, rectangle2) {
  ...
  return (
    ...
    rectangle1.y - rectangle1.h / 2 < rectangle2.y + rectangle2.h / 2 &&
    dist(rectangle1.x, rectangle1.y, rectangle2.x, rectangle2.y) <= (findCornerRadiusOfRectangle(rectangle1.w, rectangle1.h) + findCornerRadiusOfRectangle(rectangle2.w, rectangle2.h)) // <- this does not work
  )
}
